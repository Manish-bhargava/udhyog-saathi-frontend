    ...
    <div className="flex flex-col h-[calc(100vh-140px)] bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">      
      ...
      <div className="bg-white border-b border-gray-100 p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-gray-800">Saathi AI</h2>
            <p className="text-[10px] text-blue-500 font-bold uppercase tracking-wider">AI Business Agent</p>
          </div>
        </div>
        <div className="text-xs text-gray-400 font-medium">Secure Financial Analysis</div>
      </div>
      ...
      <div className="p-4 bg-white border-t border-gray-100">
        <form onSubmit={handleSendMessage} className="max-w-4xl mx-auto flex gap-3">
          <input
            ...
            onChange={(e) => setInput(e.target.value)}
            placeholder="Analyze revenue, tax summary, or top products..."
            className="flex-1 p-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm"
          />
          <button 
            type="submit" 
            disabled={isLoading || !input.trim()}
            className="bg-blue-600 hover:bg-blue-700 text-white px-5 rounded-xl transition-all disabled:opacity-50 shadow-md flex items-center gap-2"
          >
