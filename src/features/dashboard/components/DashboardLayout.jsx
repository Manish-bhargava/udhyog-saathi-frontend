...
const DashboardLayout = () => {
  ...
  const getPageTitle = () => {
    ...
    // Find nav item for current path
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <button
        ...
        className={`
          ...
          ${sidebarOpen 
            ? 'top-1/2 left-64 -right-3'  // When open: attached to sidebar right edge
            : 'top-1/2 left-0'            // When closed: left edge of screen
          }
        `}
      >
        <svg 
      ...
      `}>
        <div className="p-4 md:p-6">
          {/* This is where nested routes (DashboardPage, ProfilePage) will render */}
          <Outlet />
        </div>
      </main>
    </div>
