    ...
    <div className="space-y-8 max-w-full overflow-x-hidden">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex items-center mb-6">
          ...
          <h3 className="text-lg font-semibold text-gray-800 truncate">Buyer Details</h3>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none resize-y min-h-[100px]"
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex justify-between items-center mb-6 gap-4">
          <div className="flex items-center min-w-0">
            ...
            <h3 className="text-lg font-semibold text-gray-800 truncate">Products & Services</h3>
          </div>
          <button
            onClick={addProduct}
            className="flex-shrink-0 px-4 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors flex items-center shadow-sm"
          >
        ...
        <div className="space-y-4">
          {formData.products.map((p, i) => (
            <div key={i} className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-3 items-center p-4 bg-gray-50 rounded-lg border border-gray-200 hover:bg-white transition-colors">
              <div className="col-span-1 md:col-span-5 min-w-0">
                ...
                <textarea
                  className="w-full px-3 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm resize-none"
              ...
              <div className="col-span-1 md:col-span-2 min-w-0">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-9 pr-3 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-right text-base font-semibold text-gray-800 tracking-tight"
                    type="number"
                    step="any"
                    min="0"
                    placeholder="0"
              ...
              <div className="col-span-1 md:col-span-2 min-w-0">
                ...
                <input
                  className="w-full px-3 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-right text-base font-semibold text-gray-800 tracking-tight"
                  type="number"
                  min="0"
                  placeholder="1"
              ...
              <div className="col-span-1 md:col-span-2 text-right">
                ...
                <div className="px-3 py-2.5 bg-blue-50 border border-blue-200 rounded-lg text-sm font-bold text-blue-800 truncate font-mono">
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none text-gray-800 font-medium"
                min="0"
                step="0.01"
              />
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-700">Terms / Notes to Display on Bill</label>
          <textarea 
