  ...
  useEffect(() => {
    const fetchCompanyDetails = async () => {
      try {
        ...
        console.error("Error fetching company/bank data:", err);
      } finally {
        setLoading(false);
      }
    };
          ...
          >
            ...
            <div className="mt-4 p-3 bg-blue-50 border border-blue-100 rounded-lg">
              <p className="text-xs text-blue-700 flex items-start">
                ...
                <span>
                  <span className="font-semibold">Tip:</span> Drag the vertical divider or use layout buttons above to adjust the view. 
                  Numbers in the form will appear exactly as shown in the preview.
                </span>
              </p>
            </div>
          </div>
